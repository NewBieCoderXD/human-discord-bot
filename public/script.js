...
var guilds;
var currectChannel = undefined;
function getAndUpdateGuilds() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("/api/getGuilds")];
                case 1:
                    guilds = _a.sent();
                    return [4 /*yield*/, guilds.json()];
                case 2:
                    guilds = _a.sent();
